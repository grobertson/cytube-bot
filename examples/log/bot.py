#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Simple CyTube chat and media logger.

This is a minimal example that connects to a CyTube channel and logs
chat messages and media changes to files. It demonstrates basic bot
usage without additional features like shell control or databases.
"""
...
from common import get_config, configure_logger
from lib import Bot
...
async def run_bot():
    """Run the logging bot with proper async handling.
...
def main():
    """Main entry point for the logging bot.
